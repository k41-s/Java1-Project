...
import hr.algebra.view.model.EventTableModel;
 ...
 * @author kaish
 */
public class EditEventsPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnRefresh.setText("Refresh Panel");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(lbIcon, javax.swing.GroupLayout.PREFERRED_SIZE, 470, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(42, 42, 42)
                                .addComponent(lbPicturePathError, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(tfPicturePath, javax.swing.GroupLayout.PREFERRED_SIZE, 381, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(20, 20, 20)
                        .addComponent(lbIcon, javax.swing.GroupLayout.PREFERRED_SIZE, 313, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            ...
            MessageUtils.showErrorMessage("Error", "Unable to create event!");
        }
    }//GEN-LAST:event_btnAddActionPerformed

    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if (selectedEvent == null) {
            MessageUtils.showInformationMessage("Wrong operation", "Please choose event to update");
            return;
        }
        if (!formValid()) {
            return;
        ...
        try {
            if (!tfPicturePath.getText().trim().equals(selectedEvent.getPicturePath())) {
                if (selectedEvent.getPicturePath() != null) {
                    Files.deleteIfExists(Paths.get(selectedEvent.getPicturePath()));
                }
                String localPicturePath = uploadPicture();
                selectedEvent.setPicturePath(localPicturePath);
            }

            selectedEvent.setTitle(tfTitle.getText().trim());
            selectedEvent.setLink(tfLink.getText().trim());
            selectedEvent.setDescription(taDescription.getText().trim());
            selectedEvent.setPublishedDate(OffsetDateTime.parse(tfPublishedDate.getText().trim(), Event.DATE_FORMATTER));

            eventRepository.update(selectedEvent.getId(), selectedEvent);
            eventsTableModel.setEvents(eventRepository.selectAll());

            clearForm();
        } catch (Exception ex) {
            Logger.getLogger(EditEventsPanel.class.getName()).log(Level.SEVERE, null, ex);
            MessageUtils.showErrorMessage("Error", "Unable to update event!");
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        if (selectedEvent == null) {
            MessageUtils.showInformationMessage("Wrong operation", "Please choose event to delete");
            return;
        }
        if (MessageUtils.showConfirmDialog(
            ...
            try {
                ...
                eventRepository.delete(selectedEvent.getId());
                eventsTableModel.setEvents(eventRepository.selectAll());

                clearForm();
            } catch (Exception ex) {
                Logger.getLogger(EditEventsPanel.class.getName()).log(Level.SEVERE, null, ex);
                MessageUtils.showErrorMessage("Error", "Unable to delete event!");
            }
        }
    ...
    private void btnChooseImageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChooseImageActionPerformed
        ...
        tfPicturePath.setText(opt.get().getAbsolutePath());
        setIcon(lbIcon, opt.get());
    ...
    // JPanel constructor is called from JFrame constructor, and there may not yet be events to show
    // events can be shown only after they have been parsed for the first time
    ...
    private void initTable() throws Exception {
        ...
        eventsTableModel = new EventTableModel(eventRepository.selectAll());
        tbArticles.setModel(eventsTableModel);
    }
    ...
    private void showEvent() {
        ...
        try {
            Optional<Event> optEvent = eventRepository.selectOne(selectedEventId);
            ...
            Logger.getLogger(EditEventsPanel.class.getName()).log(Level.SEVERE, null, ex);
            MessageUtils.showErrorMessage("Error", "Unable to show event!");
        }
    }

    private void fillForm(Event event) {
        if (event.getPicturePath() != null && Files.exists(Paths.get(event.getPicturePath()))) {
            tfPicturePath.setText(event.getPicturePath());
            setIcon(lbIcon, new File(event.getPicturePath()));
        }
        tfTitle.setText(event.getTitle());
        tfLink.setText(event.getLink());
        taDescription.setText(event.getDescription());
        tfPublishedDate.setText(event.getPublishedDate().format(Event.DATE_FORMATTER));
    }
